...
# phen_file <- "ARIES_DATA_DIR/phenotypic/phenotype_data.txt"
# meta_file <- "ARIES_DATA_DIR/phenotypic/phenotype_metadata.txt"
# outfile <- "results/temp/real-phens/celldmc_res_split87.RData"
